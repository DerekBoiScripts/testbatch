...
#add another button to the form
$update = new-object -TypeName $buttons
$update.text = 'Shutdown local PC'
$update.location = New-Object -TypeName $drawing -ArgumentList (300,230) 
$update.size = New-Object -TypeName $Size -ArgumentList (110,30)
